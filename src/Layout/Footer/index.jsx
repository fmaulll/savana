...
const Footer = () => {
  ...
  return (
    <div className="">
      <div className="bg-[#004723] px-[30px] md:px-[150px] flex justify-between items-center md:py-16">
        <div className="flex flex-col">
          <img
            ...
            alt=""
          />
          <p className="text-white text-[18px] font-bold mt-4">
            Jl. Katelia Raya No. 8, RT.02/RW.09, Cilendek Timur, Kecamatan Bogor
            Barat,<br/> Kota Bogor, Jawa Barat, Indonesia<br/> 16112
          </p>
          <p className="text-white text-[18px] font-bold mt-4">Kontak Kami</p>
          <div className="[&>*]:text-white [&>*]:text-[18px] [&>*]:font-semibold mt-4">
        ...
        <div className="w-[326px]">
          {navigation.map((nav, index) => (
            <div
              key={index}
              className="flex justify-between border-b-2 border-white font-semibold text-[18px] text-white py-3 pb-1"
            >
